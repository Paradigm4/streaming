...
db$remove("variants")
iquery(db, "create array variants <start:int32,ref:string,alt:string>[chromosome=0:*,1,0,row=0:*,100000000,0]")
...
f = function(file)
{
  ...
  a = as.scidb(db, x, chunk_size=1e6)
...
db$remove("genes", force=TRUE, error=invisible)
as.scidb(db,genes, name="genes")
