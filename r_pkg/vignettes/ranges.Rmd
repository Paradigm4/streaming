...
4. Order the genes by number of variant overlaps and display the top 50
...
5. `ir1 <- IRanges(start=x\$start, end=x\$start + nchar(x\$ref))` sets up an IRanges data frame of sorted startin and ending coordinates for the variants in our chunk. In particular, end coordinate is defined as start plus the length of the reference allele. Similar ranges are set up in `ir2` below for the genes ranges.
