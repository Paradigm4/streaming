...
bootstram process. It runs in parallel on each of the 8 data partitions defined
...
```
iquery -aq "save(stream($TEST, 'Rscript /tmp/predict.R', 'format=df', 'types=string,string', model), predictions)"
```
