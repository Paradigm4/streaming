...
The scidbstrm package for R is available from https://github.com/paradigm4/stream/r_pkg. You can
install it with:
```
sudo R --slave -e  "devtools::install_github('paradigm4/stream', subdir='r_pkg')"
```
